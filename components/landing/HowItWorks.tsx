...
export function HowItWorks() {
  return (
    <section id="jak-to-dziala" className="mx-auto max-w-6xl px-6 py-20 md:py-32">
      <Reveal>
      ...
      <StaggerGroup className="mt-14 grid gap-px overflow-hidden border border-ink/15 bg-ink/15 md:grid-cols-4">
        {STEPS.map((step) => (
          <StaggerItem key={step.n} className="bg-bg p-7">
